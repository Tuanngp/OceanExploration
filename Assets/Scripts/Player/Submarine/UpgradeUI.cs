...
{
    [Header("UI Elements")]
    public GameObject upgradePanel; // Gán UpgradePanel vào đây
    public TextMeshProUGUI resourceText; // Gán ResourceText
    public Button speedButton, healthButton, weaponButton; // Gán các nút
    public TextMeshProUGUI speedText, healthText, weaponText; // Text trong các nút
    ...
    void Update()
    {
        ...
        speedText.text = $"Speed: Lv {upgradeManager.speedLevel} ({upgradeManager.speedUpgradeCost})";
        healthText.text = $"Health: Lv {upgradeManager.healthLevel} ({upgradeManager.healthUpgradeCost})";
        weaponText.text = $"Weapon: Lv {upgradeManager.weaponLevel} ({upgradeManager.weaponUpgradeCost})";
